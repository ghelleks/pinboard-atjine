...
<div id="tribe-events-event-meta" itemscope itemtype="http://schema.org/Event">
	<dl class="column">
		...
		<?php if ( tribe_get_organizer_link( get_the_ID(), false, false ) ) { ?>
			<dd itemprop="name" class="event-meta event-meta-name"><span class="summary">
			<a href="<?php echo tribe_get_event_meta( tribe_get_organizer_id( get_the_ID() ), '_OrganizerWebsite', true ); ?>"><?php the_title(); ?></a>
			</span></dd>
		<?php } else { ?>
